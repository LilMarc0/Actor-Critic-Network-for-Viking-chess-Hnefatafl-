...
class ActorNetwork(object):
    ...
    def create_actor_network(self):
        ...
        out = tflearn.fully_connected(
            net, 588, activation='sigmoid', weights_init=w_init)
    ...
    def save(self):
        print('Saving actor...')
        save_path = self.saver.save(self.sess, "./actorF/actorF.ckpt")

    def load(self):
        print('Restoring actor...')
        res_path = self.saver.restore(self.sess, "./actorF/actorF.ckpt")
...
class CriticNetwork(object):
    ...
    def create_critic_network(self):
        ...
        net = tflearn.activation(tf.matmul(net, t1.W) + tf.matmul(action, t2.W) + t2.b, activation='tanh')
    ...
    def save(self):
        print('saving critic..')
        save_path = self.saver.save(self.sess, "./criticF/criticF.ckpt")

    def load(self):
        print('Restoring critic...')
        self.saver.restore(self.sess, "./criticF/criticF.ckpt")
