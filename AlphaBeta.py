...
class ReplayBuffer(object):
    ...
    def load(self, path):
        ...
        print('Buffer found with {} data points'.format(len(self.buffer)))
...
class ActorNetwork(object):
    ...
    def create_actor_network(self):
        inputs = tflearn.input_data(shape= [None, 122])
...
class CriticNetwork(object):
    ...
    def create_critic_network(self):
        ...
        net = tflearn.fully_connected(inputs, 1000)
        net = tflearn.layers.normalization.batch_normalization(net)
        net = tflearn.activations.relu(net)

        # Add the action tensor in the 2nd hidden layer
        # Use two temp layers to get the corresponding weights and biases
        t1 = tflearn.fully_connected(net, 800)
        t2 = tflearn.fully_connected(action, 800)
